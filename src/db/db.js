...
db.version(4).stores({
  ...
  tasks:
    'id, taskId, projectId, title, description, status, assignedTo, createdAt, updatedAt,deadline, priority, type, estimatedHours, dependencies, tags, subtasks',
  comments: '++id, taskId, userId, content, createdAt',
})

// Valeurs par défaut lors de la création d'un projet
...
// Valeurs par défaut lors de la création d'une tâche
